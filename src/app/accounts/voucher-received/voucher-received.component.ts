...
@Component({
  selector: 'app-voucher-received',
  templateUrl: './voucher-received.component.html',
  styleUrls: ['./voucher-received.component.css'],
...
export class ReceivedVoucherComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder
    ...
    this.fileSrc = _domSanitizer.bypassSecurityTrustResourceUrl('');
  }
  ...
  submitForm(id: string) {
    ...
    formData.append('details', 'djs');
    return this.gSvc.postdatafile('api/Voucher/UploadFile', formData).subscribe(() => alert("File uploaded"));
  }
  ...
  frmSearch() {
    this.searchFrm = this.fb.group({
      ...
      voucherTypeId: new FormControl(2)
    })
  }
