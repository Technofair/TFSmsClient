...
@Component({
  ...
  templateUrl: './customer-server-info.component.html',
  styleUrls: ['./customer-server-info.component.css'],
  providers: [ConfirmationService]
})
export class CustomerServerInfoComponent {
 ...
 save() {
  ...
  this.confirmationService.confirm({
    ...
    accept: () => {
      ...
      this.gSvc.postdata("api/CustomerServerInfo/Save", JSON.stringify(this.frm.value)).subscribe(res => {
        if (res.success) {
          this.initialize();
          this.getCustomerServerInfo();          
...
getCustomerServerInfo() {
  this.gSvc.postdata("api/CustomerServerInfo/GetAll", {} ).subscribe(res => {    
