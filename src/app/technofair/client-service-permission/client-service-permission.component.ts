...
@Component({
  selector: 'app-client-service-permission',
  templateUrl: './client-service-permission.component.html',
  styleUrls: ['./client-service-permission.component.css'],
  providers: [ConfirmationService]
})
export class ClientServicePermissionComponent implements OnInit {
  packages: ScpPackage[] = [];
  ...
  save() {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.gSvc.postdata("api/not/making", JSON.stringify(reqestbody)).subscribe(res => {
          ...
          this.toastrService.error("Error! Api not get yet.");
        })
        return true;
      },
      reject: () => {
