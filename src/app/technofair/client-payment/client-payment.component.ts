...
// }]
  ...
  getClientApprovedUnpaidBill(companyCustomerId:any) {
    this.gSvc.postdata("api/TFAClientBill/GetClientApprovedUnpaidBill?companyCustomerId=" + companyCustomerId, {} ).subscribe(res => {
