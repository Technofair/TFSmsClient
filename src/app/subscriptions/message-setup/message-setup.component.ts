...
@Component({
  selector: 'app-stb-assign-message-setup',
  templateUrl: './message-setup.component.html',
  styleUrls: ['./message-setup.component.css'],
  providers: [ConfirmationService]
})


export class MessageSetupComponent implements OnInit {
  subscribers: any[] = [];
  ...
  frmcreate() {
    this.frm = this.fb.group({
      ...
      dVBEncoding: new FormControl(Validators.required),
