...
@Component({
  selector: 'app-subscriber-transfer-report',
  templateUrl: './subscriber-transfer-report.component.html',
  styleUrls: ['./subscriber-transfer-report.component.css'],
  // providers: [ConfirmationService]
})
export class SubscriberTransferReportComponent implements OnInit {
