...
@Component({
  ...
  templateUrl: './lso-wise-product-list.component.html',
  styleUrls: ['./lso-wise-product-list.component.css'],
  providers: [ConfirmationService]
})
export class LsoWiseProductListComponent implements OnInit {
  ...
  loadReportIn(item: any) {
    ...
    var rmodel = { reportPath: '/reportfile/report/' + repFile, reportName: 'LSO wise product list' };
